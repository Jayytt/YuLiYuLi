...
public class SearchController {
    ...
    public ResponseEntity<Map<String, Object>> searchVideos(
        ...
        List<VideoSearchDTO> results = searchService.searchVideos(keyword, page, size);
        return ResponseEntity.ok(Map.of("code", 200, "message", "success", "data", results));
    }

    @PostMapping("/index")
    public ResponseEntity<Map<String, Object>> indexVideo(@RequestBody VideoDocument videoDocument) {
